...
public class OrderTest {
    ...
    public void testGetTotalAmount() {
        ...
        Order order = new Order(LocalDate.now(), "Commande de vêtements d'été", customer);
        ...
        assertEquals(expectedTotal, actualTotal, 0.001, "Le montant total calculé doit correspondre au total attendu.");
    }
}